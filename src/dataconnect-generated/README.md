...
```typescript
listNotes(): QueryPromise<ListNotesData, undefined>;
...
```typescript
listNotes(dc: DataConnect): QueryPromise<ListNotesData, undefined>;
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, listNotes } from '@dataconnect/generated';
...
import { connectorConfig, listNotesRef } from '@dataconnect/generated';


// Call the `listNotesRef()` function to get a reference to the query.
const ref = listNotesRef();

// You can also pass in a `DataConnect` instance to the `QueryRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = listNotesRef(dataConnect);
